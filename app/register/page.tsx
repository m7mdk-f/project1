...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const fullPhoneNumber = selectedCode + phone; // +9705812968
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="!mt-10">
                <button
                  ...
                  className={`w-full shadow-xl py-2.5 px-4 text-[15px] font-medium tracking-wide rounded-lg text-white transition-all focus:outline-none ${
