        ...
        {plans.map((plan) => {
          ...
          return (
            <div
              ...
              className={`w-full max-w-sm p-4 border rounded-lg shadow-sm sm:p-8 cursor-pointer transition-transform hover:scale-105 ${
                isSelected
            ...
            >
                  ...
                  return (
                    <li
                      ...
                      className={`flex items-center ${
                        isUnavailable ? "line-through decoration-gray-500" : ""
                      }`}
                    >
                      <svg
                        className={`shrink-0 w-4 h-4 ${
                          isUnavailable ? "text-gray-400" : "text-blue-700"
                        }`}
                        aria-hidden="true"
              ...
              <button
                type="button"
                className={`text-white font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center focus:outline-none focus:ring-4 focus:ring-blue-200 ${
                  isSelected
