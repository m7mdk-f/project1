      ...
      {loading ? (
        ...
        >
          ...
          <div className="flex justify-center mb-8">
            <span
              className={`px-4 py-2 cursor-pointer rounded-r-lg ${
                billingCycle === "month"
              ...
              {plan.map((planitem) => {
                ...
                return (
                  <div
                    ...
                    className={`w-full  p-4 border rounded-lg text-center shadow-sm sm:p-8 cursor-pointer transition-transform hover:scale-105 ${
                      isSelected
