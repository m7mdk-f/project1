  ...
  return (
    <li>
      ...
      >
        ...
        {item.children && (
          <svg
            className={`absolute left-4 top-1/2 -translate-y-1/2 fill-current ${pageName === item.label.toLowerCase() ? "rotate-180" : ""
              }`}
            width="20"
            height="20"
            viewBox="0 0 20 20"
